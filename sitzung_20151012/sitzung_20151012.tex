...
Es wird festgestellt, dass die Vollversammlung der Fachschaft Informatik an der Hochschule Trier im Jahr 2015 vor der konstituierenden Sitzung des zukünftigen Fachschaftsrates stattfinden muss, da nur der aktuelle Rat einen Rechenschaftsbericht ablegen kann. Es muss ein günstiger Zeitrahmen gefunden werden, um möglich viele Kommilitonen zu erreichen.\\
...
\abstimmung{Es wird der Antrag gestellt, einen Ausschuss zu bilden der mit entsprechenden Vollmachten ausgestattet ist, welcher unabhängig vom amtierenden Fachschaftsrat Informatik die Veranstaltung "`Pi and More "' planen, vorbereiten und durchführen kann.}{8}{0}{0}
Es ergeht der Beschluss \textit{(\#FSRI\_4)} dass ein Ausschuss gebildet wird, der mit entsprechenden Vollmachten ausgestattet ist um unabhängig vom amtierenden Fachschaftsrat Informatik die Veranstaltung Planen, Vorbereiten und Durchführen kann.\\
Mitglieder dieses Ausschusses sind Michael Ochmann, Santo Pfingsten und Georg Schäfer.\\
Um Workshops mit mehr Teilnehmern anbieten zu können, sollen mehrere Raspberry Pis organisiert werden (die Veranstalter können lediglich zehn Stück zur Verfügung stellen).\\
...
Michael Ochmann teilt mit, dass er Fachseminarteilnehmer als Hauptverantwortliche für die Organisation der GameDevWeek für ungeeignet hält, da Jemand benötigt wird, der diese Planung mit "`Feuer und Flamme"' betreibt und sich nicht auf die Kernzeit des Fachseminars berufen kann.\\
